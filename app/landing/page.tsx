      ...
      <nav className="relative z-20 w-full px-6 py-6">
        <div className="mx-auto flex max-w-6xl items-center justify-between rounded-full border border-white/20 bg-white/5 px-4 py-3 backdrop-blur-md sm:px-6">
          ...
          <div className="hidden items-center gap-8 md:flex">
            ...
            <Link href="/projects" className="text-sm font-medium text-white/80 no-underline hover:text-white">Hub Proyek</Link>
            <Link href="#" className="text-sm font-medium text-white/80 no-underline hover:text-white">Tentang Kami</Link>
          </div>
